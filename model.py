...
class DecoderBlock(nn.Module):
    ...
    def __init__(self,self_attention_block:MultiHeadAttentionBlock, encoder_attention_block:MultiHeadAttentionBlock, feed_forward_block:FeedForwardBlock, dropout:float) -> None:
        super().__init__()
        self.self_attention_block = self_attention_block
        self.encoder_attention_block = encoder_attention_block
        self.feed_forward_block = feed_forward_block
